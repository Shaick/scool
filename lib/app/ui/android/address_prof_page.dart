...
class AddressProfPage extends StatelessWidget {
  ...
  void onPressed() {
    if (_formKey.currentState.validate()) {
      ...
      Map<String, dynamic> map = {
        ...
        "uf": uff.value,
        "cidade": cityctrl.text,
        "cep": zipctrl.text,
        "bairro": districtctrl.text,
        "endereco": addressctrl.text,
        "complemento": cpctrl.text,
      };
      box.write('entry', map);
      Get.toNamed(Routes.SIGNUPROF);
    }
  }
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: DropdownButton(
                                  ...
                                  onChanged: (value) {
                                    // _entryController.changeUF = value;
                                    uff.value = value;
                                  },
                                ),
                              ),
